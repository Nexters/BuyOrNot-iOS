...
/// Since Splash is a static framework, the bundle containing the resources is copied into the final product.
static let module: Bundle = {
    let bundleName = "Splash_Splash"
    ...
    fatalError("unable to find bundle named Splash_Splash")
}()
}
// MARK: - Objective-C Bundle Accessor
@objc
public class SplashResources: NSObject {
