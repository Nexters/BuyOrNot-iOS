...
/// Since CreateVote is a static framework, the bundle containing the resources is copied into the final product.
static let module: Bundle = {
    let bundleName = "CreateVote_CreateVote"
    ...
    fatalError("unable to find bundle named CreateVote_CreateVote")
}()
}
// MARK: - Objective-C Bundle Accessor
@objc
public class CreateVoteResources: NSObject {
