...
public enum DesignSystemAsset: Sendable {
  ...
  public static let camera = DesignSystemImages(name: "camera")
    ...
    public static let crop = DesignSystemImages(name: "crop")
    public static let crop34 = DesignSystemImages(name: "crop_3_4")
    public static let crop43 = DesignSystemImages(name: "crop_4_3")
    public static let cropFree = DesignSystemImages(name: "crop_free")
    public static let cropSquare = DesignSystemImages(name: "crop_square")
    ...
    public static let rotateLeft = DesignSystemImages(name: "rotate_left")
