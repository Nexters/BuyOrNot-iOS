...
public struct Vote {
    ...
    public init(feedId: Int, content: String, price: Int, category: FeedCategory, yesCount: Int, noCount: Int, voteStatus: VoteStatus, s3ObjectKey: String, imageWidth: Int, imageHeight: Int, author: FeedAuthor, createdAt: DateComponents) {
        self.feedId = feedId
